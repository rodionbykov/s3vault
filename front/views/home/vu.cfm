...
<nav aria-label="You are here:" role="navigation">
  <ul class="breadcrumbs">
    ...
    <cfset arrPath = ListToArray(rc.p, "/") />
    <cfset path = "" />
    <cfloop array="#arrPath#" index="p1">
    <cfset path = path & "/" & p1 />
    <li><a href="index.cfm?do=home.go&amp;buid=#rc.bucket.id#&amp;go=#ToBase64(path)#">#HTMLEditFormat(p1)#</a></li>    
    </cfloop>    
    <li>
      <span class="show-for-sr">Current: </span> #HTMLEditFormat(rc.o)#
    </li>    
  </ul>
</nav>
</cfoutput>
...
<div class="row">
  ...
  <div class="large-8 columns">
    ...
    <cfif rc.qryDirectory.type EQ "Dir">
        <li>
          <span class="label folder"><i class="fi-folder"></i> <a href="index.cfm?do=home.go&amp;buid=#rc.bucket.id#&amp;go=#ToBase64(path & "/" & rc.qryDirectory.name, "utf-8")#">#HTMLEditFormat(rc.qryDirectory.name)#</a></span>
        </li>
    <cfelse>
      <cfset ext = ListLast(rc.qryDirectory.name, ".") />
      <cfif ext EQ "mp4">
        <li <cfif rc.qryDirectory.name EQ rc.o>class="current"</cfif>>
          <span class="label video"><i class="fi-play-video"></i> <a href="index.cfm?do=home.vu&amp;buid=#rc.bucket.id#&amp;p=#ToBase64(path, "utf-8")#&amp;o=#ToBase64(rc.qryDirectory.name, "utf-8")#">#HTMLEditFormat(rc.qryDirectory.name)#</a></span>
      ...
      <cfelse>
        <li>
          <span class="label file"><i class="fi-page"></i> <a target="_blank" href="#rc.bucket.website##path#/#rc.qryDirectory.name#">#HTMLEditFormat(rc.qryDirectory.name)#</a></span>
